...
<?if((int)$_REQUEST['ELEMENT_ID'] && (int)$_REQUEST['IBLOCK_ID'] && \Bitrix\Main\Loader::includeModule('aspro.next')):?>
	<?$APPLICATION->IncludeComponent("aspro:oneclickbuy.next", "shop", array(
		...
		"DEFAULT_DELIVERY" => COption::GetOptionString('aspro.next', 'ONECLICKBUY_DELIVERY', '1', SITE_ID),
		"DEFAULT_PAYMENT" => COption::GetOptionString('aspro.next', 'ONECLICKBUY_PAYMENT', '2', SITE_ID),
