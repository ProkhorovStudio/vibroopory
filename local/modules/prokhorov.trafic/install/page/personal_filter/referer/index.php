    ...
    <div class="row">
        <div class="col-lg-2">
            <div class="menu-block">
                ...
                <a href="/personal_filter/referer/ " class="active">Рефереры</a>
                <a href="/personal_filter/config/" >Настройки</a>
                <?if($permission):?><a href="/personal_filter/email/" >Настройки оповещения</a><?endif;?>
            </div>
        </div>
        <div class="col-lg-10">
            <?if($permission):?><button id="addIp">Добавить</button><?endif;?>
            <?if(HlBlock::getIdHlRef()):


                $idHl = HlBlock::getIdHlRef();?>
...
<div class="modalAdd">
  ...
  <path fill="none" stroke="#000000" stroke-width="2" d="M7,7 L17,17 M7,17 L17,7"/>
        ...
        <input type="text" name="IP" class="IP" required placeholder="">
