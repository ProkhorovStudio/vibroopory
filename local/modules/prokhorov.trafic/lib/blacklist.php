...
class BlackList {
    protected $titleRu = 'Черный список IP';
    protected $titleEn = 'Black IP list';
    protected $name = 'BlackIpList';
    protected $table_name = 'iplist_black';
    ...
    public static function checkTable($ip){
        $hlbl = HL\HighloadBlockTable::getList(["filter" => ["NAME" => 'BlackIpList']])->fetchObject();
        if(!$hlbl['ID'])
        {
            return false;
        }
