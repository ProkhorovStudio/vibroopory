...
$APPLICATION->SetPageProperty("keywords", "помощь, оформление, заказ");
$APPLICATION->SetPageProperty("description", "Как оформить заказ");
...
<ol>
	<li> Вы оставляете заявку на сайте </li>
	<li>Перезваниваем Вам для уточнения деталей</li>
	<li>Выезжаем на объект (при необходимости)</li>
	<li>Заключаем договор</li>
	<li>Доставляем на объект транспортной компанией</li>
	<li>Вы остаетесь довольны качеством</li>
