...
$APPLICATION->SetPageProperty("keywords", "гарантия, товар, правила, обмен, возврат");
...
<h2 style="font-size: 1.2em">С какого момента начинается гарантия?</h2>
<ul>
	<li>
...
<h2 style="font-size: 1.2em">Правила обмена и возврата товара:</h2>
<h3 style="font-size: 1.2em">Обмен и возврат продукции надлежащего качества</h3>
<p>
...
<h3 style="font-size: 1.2em">Обмен и возврат продукции ненадлежащего качества</h3>
<p>
...
<h3 style="font-size: 1.2em">Возврат денежных средств</h3>
<p>
	 Срок возврата денежных средств зависит от вида оплаты, который изначально выбрал покупатель.
</p>
<p>
	 При наличном расчёте возврат денежных средств осуществляется на кассе не позднее, чем через через 10 дней после предъявления покупателем требования о возврате.
</p>
<p>
