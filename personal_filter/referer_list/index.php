...
$filter[]= ['UF_IP_SOVPADENIE' => 'Реферер'];
...
$('.searchIp').click(function(){
        ...
        console.log(hasDateOrDateStartParameter());
...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <h1>Сводка списка IP по маске</h1>
        </div>
    ...
    <div class="row">
        <div class="col-lg-2">
            <div class="menu-block">
                ...
                <a href="/personal_filter/referer_list/" class="active">Список по рефереру</a>
                <hr>
