    ...
    <div class="row">
        <div class="col-lg-2">
            <div class="menu-block">
                ...
                <?if($permission):?><a class="active" href="/personal_filter/email/" >Настройки оповещения</a><?endif;?>
            </div>
        </div>
        <div class="col-lg-10">
            <?if($permission):?><button id="addIp">Добавить email</button><?endif;?>
            <?if(HlBlock::getIdHlEmails()):


                $idHl = HlBlock::getIdHlEmails();?>
...
<div class="modalAdd">
  ...
  <path fill="none" stroke="#000000" stroke-width="2" d="M7,7 L17,17 M7,17 L17,7"/>
        ...
        <input type="text" name="EMAIL" class="EMAIL" required placeholder="Введите email">
