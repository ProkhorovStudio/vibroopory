    ...
    <div class="row">
        <div class="col-lg-2">
            <div class="menu-block">
                ...
                <hr>
                <a href="/personal_filter/black/" class="active">Черный список IP</a>
        ...
        <div class="col-lg-10">
            <?if($permission):?><button id="addIp">Добавить IP</button><?endif;?>
            <?if(HlBlock::getIdHlBlack()):


                $idHl = HlBlock::getIdHlBlack();?>
...
<div class="modalAdd">
  ...
  <path fill="none" stroke="#000000" stroke-width="2" d="M7,7 L17,17 M7,17 L17,7"/>
        ...
        <input type="text" name="IP" class="IP" required placeholder="Введите IP">
