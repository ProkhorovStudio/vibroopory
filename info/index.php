...
$APPLICATION->SetPageProperty("keywords", "справочная, информация");
$APPLICATION->SetPageProperty("description", "Справочная информация на сайте помогает посетителю ресурса быстрее найти ответы на вопросы");
