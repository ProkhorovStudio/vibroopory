...
$APPLICATION->SetPageProperty("keywords", "вопросы, ответы");
$APPLICATION->SetPageProperty("description", "В данном разделе приведены ответа на часто задаваемые вопросы");
