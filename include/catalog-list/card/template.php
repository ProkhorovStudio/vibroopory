...
<?$count = $actualItem['CATALOG_QUANTITY'];
	if($count < 10){
		$status = "Мало";
	}
...
?>
<div class="product-item-catalog">
...
<? endif; ?>
	<div class="product-item-description">
		<? if ($itemHasDetailUrl): ?>
		<a class="product-item-name" href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=$productTitle?>">
			<? endif; ?>
			<?=$productTitle?>
			<? if ($itemHasDetailUrl): ?>
		</a>
	<? endif; ?>
	<div class="item-stock"><span class="icon stock stock_range_2"></span><?=$status?></div>
	</div>
	<?
				...
				case 'quantityLimit':
					if ($arParams['SHOW_MAX_QUANTITY'] !== 'N')
					{
						if ($haveOffers)
						{
							...
							{
								?>
								<div class="product-item-info-container product-item-hidden counter_block"
							...
							?>
								...
								<div class="product-item-amount">
									<div class="product-item-amount-field-container">
										...
										<span class="product-item-amount-field-btn-plus no-select" id="<?=$itemIds['QUANTITY_UP']?>" max="<?=$count?>"></span>
									</div>
								</div>
							</div>
						...
						if (!$haveOffers)
						{
							if ($actualItem['CAN_BUY'])
							{
								...
								<div class="product-item-button-container">
									<span data-value="<?=$itemIds['PRICE_TOTAL']?>" data-currency="RUB" data-rid="" class="small to-cart btn btn-default transition_bg animate-load" data-item="<?=$actualItem['ID']?>" data-float_ratio="1" data-ratio="1" data-bakset_div="bx_basket_div_<?=$actualItem['ID']?>" data-props="" data-part_props="Y" data-add_props="Y" data-empty_props="Y" data-offers="" data-iblockid="18" data-quantity="1"><i></i><span>В корзину</span></span>
									<a rel="nofollow" href="/basket/" class="small in-cart btn btn-default transition_bg" data-item="<?=$actualItem['ID']?>" style="display: none;"><i></i><span>В корзине</span></a>
								</div>
								<?
							}
							else
