...
function setQuantityFly(basketId, ratio, direction, max = 1){
	...
	if (direction == 'up' && curValue > max) {

		let text = "Вы добавили в корзину максимально доступное на сегодня количество " + "<b>"+max+" шт</b>" +". Пожалуйста, свяжитесь с нами любым удобным способом и мы подберем для вас товар аналогичных технических характеристик и качества.";
