...
else
{
	...
	?>
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" class="order-form-people" enctype="multipart/form-data" ym(34359175,'reachGoal','standartorder')>
		<?
