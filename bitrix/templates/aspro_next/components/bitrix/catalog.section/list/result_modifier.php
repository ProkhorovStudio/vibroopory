...
$res = CIBlockSection::GetList([],['ID' => $sectionId, 'IBLOCK_ID' => $iblockId], false, array('UF_SECTION_GROUP'));
if($section_group = $res->GetNext()){
    $arResult['UF_SECTION_GROUP'] = $section_group['UF_SECTION_GROUP'];
}
