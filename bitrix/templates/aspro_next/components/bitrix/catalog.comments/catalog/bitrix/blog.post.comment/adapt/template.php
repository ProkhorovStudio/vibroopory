				...
				<div class="form blog-comment-fields">
                    ...
                    <div class="licence_block filter label_block">
                        ...
                        <label for="licenses_inline">
                            <div id="bx_incl_area_14_1_1_3_1">Нажимая на кнопку, я даю <a href="/soglasie-na-obrabotku-pd/" target="_blank">согласие на обработку</a> моих персональных данных в соответствии с<a href="/politika-pd/" target="_blank"> Политикой</a></div>					</label>
                    </div>
				...
				if($comment["PUBLISH_STATUS"] == BLOG_PUBLISH_STATUS_PUBLISH || $comment["SHOW_SCREENNED"] == "Y" || $comment["ID"] == "preview")
				{
					...
					<div class="blog-comment-info">
						...
						<div class="left_info">
							...
							{
								?>
								<span class="blog-author_span">Имя: </span><div class="blog-author"><?=$comment["AuthorName"];?></div>
								<?
							}
