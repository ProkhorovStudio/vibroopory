                                ...
                                <?elseif ($arHeader["id"] == "QUANTITY"):?>
                                    <td class="count-cell" style="vertical-align: top !important; padding-left: 2px; padding-right: 2px;">
                                        <div class="counter_block basket">
                                            ...
                                            >
                                            <?if (isset($arItem["AVAILABLE_QUANTITY"]) /*&& floatval($arItem["AVAILABLE_QUANTITY"]) != 0*/ /*&& !CSaleBasketHelper::isSetParent($arItem)*/):?><span onclick="setQuantityFly('<?=$arItem["ID"]?>', '<?=$arItem["MEASURE_RATIO"]?>', 'up', <?=$arItem["AVAILABLE_QUANTITY"]?>)" class="plus">+</span><?endif;?>
                                        </div>
